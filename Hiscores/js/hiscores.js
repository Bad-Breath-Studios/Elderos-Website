...
(function () {
    ...
    // Skill icon = /shared/sprites/skills/{filename}.png
    const SKILLS = [
        { id: -1, key: 'overall',       name: 'Overall',       icon: '/shared/sprites/skills/overall.png' },
        { id: 0,  key: 'attack',        name: 'Attack',        icon: '/shared/sprites/skills/attack.png' },
        { id: 1,  key: 'defence',       name: 'Defence',       icon: '/shared/sprites/skills/defence.png' },
        { id: 2,  key: 'strength',      name: 'Strength',      icon: '/shared/sprites/skills/strength.png' },
        { id: 3,  key: 'hitpoints',     name: 'Hitpoints',     icon: '/shared/sprites/skills/constitution.png' },
        { id: 4,  key: 'ranged',        name: 'Ranged',        icon: '/shared/sprites/skills/range.png' },
        { id: 5,  key: 'prayer',        name: 'Prayer',        icon: '/shared/sprites/skills/prayer.png' },
        { id: 6,  key: 'magic',         name: 'Magic',         icon: '/shared/sprites/skills/magic.png' },
        { id: 7,  key: 'cooking',       name: 'Cooking',       icon: '/shared/sprites/skills/cooking.png' },
        { id: 8,  key: 'woodcutting',   name: 'Woodcutting',   icon: '/shared/sprites/skills/woodcutting.png' },
        { id: 9,  key: 'fletching',     name: 'Fletching',     icon: '/shared/sprites/skills/fletching.png' },
        { id: 10, key: 'fishing',       name: 'Fishing',       icon: '/shared/sprites/skills/fishing.png' },
        { id: 11, key: 'firemaking',    name: 'Firemaking',    icon: '/shared/sprites/skills/firemaking.png' },
        { id: 12, key: 'crafting',      name: 'Crafting',      icon: '/shared/sprites/skills/crafting.png' },
        { id: 13, key: 'smithing',      name: 'Smithing',      icon: '/shared/sprites/skills/smithing.png' },
        { id: 14, key: 'mining',        name: 'Mining',        icon: '/shared/sprites/skills/mining.png' },
        { id: 15, key: 'herblore',      name: 'Herblore',      icon: '/shared/sprites/skills/herblore.png' },
        { id: 16, key: 'agility',       name: 'Agility',       icon: '/shared/sprites/skills/agility.png' },
        { id: 17, key: 'thieving',      name: 'Thieving',      icon: '/shared/sprites/skills/thieving.png' },
        { id: 18, key: 'slayer',        name: 'Slayer',        icon: '/shared/sprites/skills/slayer.png' },
        { id: 19, key: 'farming',       name: 'Farming',       icon: '/shared/sprites/skills/farming.png' },
        { id: 20, key: 'runecraft',     name: 'Runecraft',     icon: '/shared/sprites/skills/runecrafting.png' },
        { id: 21, key: 'hunter',        name: 'Hunter',        icon: '/shared/sprites/skills/hunter.png' },
        { id: 22, key: 'augmentation',  name: 'Augmentation',  icon: '/shared/sprites/skills/augmentation.png' },
    ];

    const BOSSES = [
        { key: 'general-graardor',  name: 'General Graardor',  icon: '/shared/sprites/bosses/general_graador.png' },
        { key: 'kril-tsutsaroth',   name: "K'ril Tsutsaroth",  icon: '/shared/sprites/bosses/kril_tsutsaroth.png' },
        { key: 'commander-zilyana', name: 'Commander Zilyana',  icon: '/shared/sprites/bosses/commander_zilyana.png' },
        { key: 'kreearra',          name: "Kree'arra",         icon: '/shared/sprites/bosses/kree_arra.png' },
        { key: 'vorkath',           name: 'Vorkath',           icon: '/shared/sprites/bosses/vorkath.png' },
        { key: 'zulrah',            name: 'Zulrah',            icon: '/shared/sprites/bosses/zulrah.png' },
        { key: 'corporeal-beast',   name: 'Corporeal Beast',   icon: '/shared/sprites/bosses/corporeal_beast.png' },
        { key: 'cerberus',          name: 'Cerberus',          icon: '/shared/sprites/bosses/cerberus.png' },
        { key: 'king-black-dragon', name: 'King Black Dragon',  icon: '/shared/sprites/bosses/king_black_dragon.png' },
        { key: 'kalphite-queen',    name: 'Kalphite Queen',     icon: '/shared/sprites/bosses/kalphite_queen.png' },
        { key: 'giant-mole',        name: 'Giant Mole',         icon: '/shared/sprites/bosses/giant_mole.png' },
        { key: 'kraken',            name: 'Kraken',             icon: '/shared/sprites/bosses/kraken.png' },
        { key: 'nightmare',         name: 'Nightmare',          icon: '/shared/sprites/bosses/nightmare.png' },
        { key: 'nex',               name: 'Nex',                icon: '/shared/sprites/bosses/nex.png' },
        { key: 'jad',               name: 'TzTok-Jad',          icon: '/shared/sprites/bosses/jad.png' },
        { key: 'scorpia',           name: 'Scorpia',            icon: '/shared/sprites/bosses/scorpia.png' },
        { key: 'chaos-elemental',   name: 'Chaos Elemental',    icon: '/shared/sprites/bosses/chaos_elemental.png' },
        { key: 'callisto',          name: 'Callisto',           icon: '/shared/sprites/bosses/callisto.png' },
    ];

    const ACTIVITIES = [
        { key: 'barrows', name: 'Barrows', icon: '/shared/sprites/minigames/barrows.png' },
    ];

    const MODES = [
        { key: 'all',       label: 'All',       icon: '/shared/sprites/game-ranks/ADVENTURER.png' },
        { key: 'normal',    label: 'Normal',    icon: '/shared/sprites/game-ranks/ADVENTURER.png' },
        { key: 'ironman',   label: 'Ironman',   icon: '/shared/sprites/game-ranks/IRONMAN.png' },
        { key: 'hardcore',  label: 'Hardcore',  icon: '/shared/sprites/game-ranks/HARDCORE_IRONMAN.png' },
        { key: 'ultimate',  label: 'Ultimate',  icon: '/shared/sprites/game-ranks/ULTIMATE_IRONMAN.png' },
        { key: 'group',     label: 'Group',     icon: '/shared/sprites/game-ranks/GROUP_IRONMAN.png' },
        { key: 'perma',     label: 'Perma',     icon: '/shared/sprites/game-ranks/PERMA_IRONMAN.png' },
    ];

    const DONATORS = [
        { key: 'all',         label: 'All',       icon: null },
        { key: 'sapphire',    label: 'Sapphire',  icon: '/shared/sprites/donator-ranks/SAPPHIRE.png' },
        { key: 'emerald',     label: 'Emerald',   icon: '/shared/sprites/donator-ranks/EMERALD.png' },
        { key: 'ruby',        label: 'Ruby',       icon: '/shared/sprites/donator-ranks/RUBY.png' },
        { key: 'diamond',     label: 'Diamond',    icon: '/shared/sprites/donator-ranks/DIAMOND.png' },
        { key: 'dragonstone', label: 'Dragon.',    icon: '/shared/sprites/donator-ranks/DRAGONSTONE.png' },
        { key: 'onyx',        label: 'Onyx',       icon: '/shared/sprites/donator-ranks/ONYX.png' },
        { key: 'zenyte',      label: 'Zenyte',     icon: '/shared/sprites/donator-ranks/ZENYTE.png' },
        { key: 'eternal',     label: 'Eternal',    icon: '/shared/sprites/donator-ranks/ETERNAL.png' },
        { key: 'ascendant',   label: 'Ascendant',  icon: '/shared/sprites/donator-ranks/ASCENDANT.png' },
    ];
